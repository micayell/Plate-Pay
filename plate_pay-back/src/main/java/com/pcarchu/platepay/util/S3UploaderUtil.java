...
public class S3UploaderUtil {
    ...
    public PlatePayFile uploadFile(MultipartFile multipartFile, String type) throws IOException {
    ...
    private PlatePayFile upload(File uploadFile, String type) {
